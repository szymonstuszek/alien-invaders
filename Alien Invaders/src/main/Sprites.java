...
public class Sprites {
	...
	public void initGraphics() {
		alienURL = Sprites.class.getResource("/res/alien.png");
		alien2URL = Sprites.class.getResource("/res/alien2.png");
		playerURL = Sprites.class.getResource("/res/player.png");
		explosionURL = Sprites.class.getResource("/res/alien_die.png");
		playerDieURL = Sprites.class.getResource("/res/player_die.png");
		alienBombURL = Sprites.class.getResource("/res/alien_bomb.png");
		playerBombURL = Sprites.class.getResource("/res/player_bomb.png");
		shield3URL = Sprites.class.getResource("/res/shield3.png");
		shield2URL = Sprites.class.getResource("/res/shield2.png");
		shield1URL = Sprites.class.getResource("/res/shield1.png");
		dropURL = Sprites.class.getResource("/res/drop.png");
		bossURL = Sprites.class.getResource("/res/boss.png");
		plasmaURL = Sprites.class.getResource("/res/plasma.png");
		particleURL = Sprites.class.getResource("/res/particle.png");
